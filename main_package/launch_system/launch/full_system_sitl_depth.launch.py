...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # 3. Gazebo bridge for stereo camera data
        Node(
        ...
        Node(
            package='ros_gz_bridge',
            executable='parameter_bridge',
            name='depth_point_bridge',
            arguments=['/depth_camera/points@sensor_msgs/msg/PointCloud2@gz.msgs.PointCloudPacked'],
            output='screen'
        ),
       
        # 4. Static transform for stereo camera
        Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            name='depth_tf_publisher',
            arguments=['0.0', '0.0', '0.0', '0', '0', '0', 'base_link', 'x500_depth_0/camera_link/StereoOV7251'],
            output='screen'
        ),
